...
namespace WitnessVisualizer
{
    class PuzzleToolkit
    {
        ...
        public static PuzzleToolkit CreateDefaultPuzzleToolkit()
        {
            ...
            Toolkit.Items.Add(new PuzzleToolkitDecoratorItem("Skew Tetris", new PuzzleGraph.Decorators.TetrisDecorator() { Indexes = new List<int>() { 0, 1, 2, 3 }, Angel = -15 }));
            Toolkit.Items.Add(new PuzzleToolkitDecoratorItem("Skew Hollow Tetris", new PuzzleGraph.Decorators.HollowTetrisDecorator() { Indexes = new List<int>() { 0, 1, 2, 3 }, Angel = -15 }));
